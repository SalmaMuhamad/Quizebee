...
namespace QuizbeePlus.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            return View("Register", "_LayoutEmpty", RegisterViewModel);
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new QuizbeeUser { UserName = model.Username, Email = model.Email, RegisteredOn = DateTime.Now, MinistryId=model.MinistryID};
